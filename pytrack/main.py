...
dev_eui = binascii.unhexlify('00C435FB8460DBE0') # these settings can be found from TTN
app_eui = binascii.unhexlify('70B3D57EF000621E') # these settings can be found from TTN
app_key = binascii.unhexlify('C520CE7D05798E4F19A0BA121E1402CF') # these settings can be found from TTN
